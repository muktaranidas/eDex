        ...
        <div className="flex flex-row justify-center w-[1440px] mx-auto items-center">
          ...
          <div className="w-[1320px] ">
            ...
            >
              <div className=" ">
                <SwiperSlide>
                  <div className="feedback-card-div transition ease-in-out  delay-150 hover:-translate-y-1  hover:bg-[#F096C8] duration-300 ">
                    ...
                    <p className="pt-[35px] customer-feedback">
